...
// Glassmorphic Container Base - Theme Aware
const GlassContainer = styled(motion.div)`
  ...
  border: 1px solid ${props => props.theme.colors.background === '#ffffff' 
    ? 'rgba(0, 0, 0, 0.1)' 
...
const HeroTitle = styled(motion.h1)`
  ...
  font-weight: 800;
  background: ${props => props.theme.colors.background === '#ffffff' 
    ? 'linear-gradient(135deg, #0f172a 0%, #ff6b35 50%, #0f172a 100%)'
    : 'linear-gradient(135deg, #f8fafc 0%, #ff6b35 50%, #f8fafc 100%)'};
...
const StatCard = styled(GlassContainer)`
  ...
  &:hover {
    ...
    box-shadow: ${props => props.theme.colors.background === '#ffffff' 
      ? '0 20px 50px rgba(0, 0, 0, 0.15), inset 0 1px 0 rgba(255, 255, 255, 0.9)'
      : '0 20px 50px rgba(0, 0, 0, 0.4), inset 0 1px 0 rgba(255, 255, 255, 0.2)'};
  }
`;
...
const CompanyCard = styled(GlassContainer)<{ accentColor?: string }>`
  ...
  &:hover {
    ...
    box-shadow: ${props => props.theme.colors.background === '#ffffff' 
      ? '0 25px 60px rgba(0, 0, 0, 0.2), inset 0 1px 0 rgba(255, 255, 255, 0.9)'
      ...
      <CompaniesSection>
        ...
        <QuickStartGrid>
          ...
          >
            ...
            <p>
              Start with ML fundamentals through interactive visualizations, progressive disclosure, and hands-on practice. 
              Master statistics, probability, linear algebra, and core concepts with animated explanations and live coding exercises.
            </p>
          </QuickStartCard>
