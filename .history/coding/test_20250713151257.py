...
# Example datasets for image classification

# 1. MNIST - Handwritten digits (28x28 grayscale, 10 classes)
def load_mnist():
...
# 3. Fashion-MNIST - Fashion items (28x28 grayscale, 10 classes: T-shirt, Trouser, Pullover, etc.)
def load_fashion_mnist():
    """Load Fashion-MNIST dataset for fashion item classification"""
    transform = transforms.Compose([
        transforms.ToTensor(),
...
# 4. CIFAR-100 - More challenging with 100 classes
def load_cifar100():
    """Load CIFAR-100 dataset for fine-grained classification"""
    transform = transforms.Compose([
        transforms.ToTensor(),
